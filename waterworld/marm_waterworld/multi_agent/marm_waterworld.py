...
from marm_waterworld.multi_agent.marm_waterworld_base import FPS
from marm_waterworld.multi_agent.marm_waterworld_base import MARMWaterworldBase as _env
...
class raw_env(AECEnv, EzPickle):
    ...
    def __init__(self, reward_shaping, seed=None, *args, **kwargs):
        EzPickle.__init__(self, *args, **kwargs)
        AECEnv.__init__(self)
        self.env = _env(reward_shaping=reward_shaping, *args, **kwargs)
