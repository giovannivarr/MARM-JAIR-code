...
def buttons_config(num_times, num_agents, strategy_rm=False):
    """
    ...
    for i in range(num_agents):
        if not strategy_rm:
            local_rm_string = os.path.join(base_file_path, 'reward_machine_files', 'buttons',
    ...
    if strategy_rm:
        joint_rm_file = os.path.join(base_file_path, 'reward_machine_files', 'buttons', 'team_buttons_strategy.txt')
    else:
        joint_rm_file = os.path.join(base_file_path, 'reward_machine_files', 'buttons', 'team_buttons_rm.txt')
