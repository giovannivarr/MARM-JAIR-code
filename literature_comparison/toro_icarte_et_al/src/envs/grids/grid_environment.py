...
class OfficeRMToroIcarteEnv(GridRMEnv):
    def __init__(self):
        rm_files = ["./envs/grids/reward_machines/office/toro-icarte-rm.txt"]
        env = OfficeWorld()
        super().__init__(GridEnv(env),rm_files)

class OfficeRMStrategyEnv(GridRMEnv):
    def __init__(self):
        rm_files = ["./envs/grids/reward_machines/office/strategy-rm.txt"]
        env = OfficeWorld()
        super().__init__(GridEnv(env),rm_files)